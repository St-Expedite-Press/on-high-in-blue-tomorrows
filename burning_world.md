...
[A_World_Burning/README](A_World_Burning/README.md) | [A_World_Burning/30-whitepaper-toc](A_World_Burning/30-whitepaper-toc.md) | [A_World_Burning/26-whitepaper-skeleton](A_World_Burning/26-whitepaper-skeleton.md) | [whitepaper/White Paper I](whitepaper/White%20Paper%20I.md)
...
> - Source-of-truth outline (maximal): [A_World_Burning/26-whitepaper-skeleton](A_World_Burning/26-whitepaper-skeleton.md)
> - Extraction + preprocessing contracts (implementation-facing): [A_World_Burning/00_preprocessing_assay](A_World_Burning/00_preprocessing_assay.md), [A_World_Burning/33-appendix-b-filesystem-naming-run-ids](A_World_Burning/33-appendix-b-filesystem-naming-run-ids.md), [A_World_Burning/34-appendix-c-feature-extraction-inventory](A_World_Burning/34-appendix-c-feature-extraction-inventory.md)
> - Appendices A–J (paper-ready): [A_World_Burning/32-appendix-a-corpus-and-source-registry](A_World_Burning/32-appendix-a-corpus-and-source-registry.md) through [A_World_Burning/41-appendix-j-glossary](A_World_Burning/41-appendix-j-glossary.md)
...
Use the clickable map: [A_World_Burning/30-whitepaper-toc](A_World_Burning/30-whitepaper-toc.md).
...
> [A_World_Burning/26-whitepaper-skeleton](A_World_Burning/26-whitepaper-skeleton.md) • [A_World_Burning/38-appendix-g-ethical-and-interpretive-guardrails](A_World_Burning/38-appendix-g-ethical-and-interpretive-guardrails.md) • [A_World_Burning/36-appendix-e-reproducibility-protocols](A_World_Burning/36-appendix-e-reproducibility-protocols.md)
...
This section’s non-claims and guardrails are formalized in [A_World_Burning/38-appendix-g-ethical-and-interpretive-guardrails](A_World_Burning/38-appendix-g-ethical-and-interpretive-guardrails.md).
...
> [!note] Primary technical references
> [A_World_Burning/32-appendix-a-corpus-and-source-registry](A_World_Burning/32-appendix-a-corpus-and-source-registry.md) • [A_World_Burning/33-appendix-b-filesystem-naming-run-ids](A_World_Burning/33-appendix-b-filesystem-naming-run-ids.md)
...
> [!note] Primary technical references
> [A_World_Burning/32-appendix-a-corpus-and-source-registry](A_World_Burning/32-appendix-a-corpus-and-source-registry.md) • [A_World_Burning/33-appendix-b-filesystem-naming-run-ids](A_World_Burning/33-appendix-b-filesystem-naming-run-ids.md) • [A_World_Burning/28-sources-and-variant-acquisition](A_World_Burning/28-sources-and-variant-acquisition.md) • [A_World_Burning/00_preprocessing_assay](A_World_Burning/00_preprocessing_assay.md)
...
Canonical corpus boundaries and plate identity fields are specified in [A_World_Burning/32-appendix-a-corpus-and-source-registry](A_World_Burning/32-appendix-a-corpus-and-source-registry.md).
...
The acquisition discipline and variant registration schema are specified in [A_World_Burning/28-sources-and-variant-acquisition](A_World_Burning/28-sources-and-variant-acquisition.md).
...
The full layout, naming law, and run-sealing protocol are specified in [A_World_Burning/33-appendix-b-filesystem-naming-run-ids](A_World_Burning/33-appendix-b-filesystem-naming-run-ids.md).
...
> [!note] Primary technical references
> [A_World_Burning/34-appendix-c-feature-extraction-inventory](A_World_Burning/34-appendix-c-feature-extraction-inventory.md) • [A_World_Burning/29-model-library](A_World_Burning/29-model-library.md) • [A_World_Burning/39-appendix-h-model-cards-and-dependency-registry](A_World_Burning/39-appendix-h-model-cards-and-dependency-registry.md) • [A_World_Burning/00_preprocessing_assay](A_World_Burning/00_preprocessing_assay.md)
...
The exhaustive feature inventory (with storage targets and failure modes) lives in [A_World_Burning/34-appendix-c-feature-extraction-inventory](A_World_Burning/34-appendix-c-feature-extraction-inventory.md).
...
> [!note] Primary technical references
> [A_World_Burning/35-appendix-d-segmentation-methods-and-parameters](A_World_Burning/35-appendix-d-segmentation-methods-and-parameters.md) • [A_World_Burning/29-model-library](A_World_Burning/29-model-library.md) • [A_World_Burning/27-strange-models-compendium](A_World_Burning/27-strange-models-compendium.md)
...
All segmentation details—including parameters, tiling strategies, post-processing rules, and explicit non-claims—are specified in [A_World_Burning/35-appendix-d-segmentation-methods-and-parameters](A_World_Burning/35-appendix-d-segmentation-methods-and-parameters.md).
...
> [!note] Primary technical references
> [A_World_Burning/36-appendix-e-reproducibility-protocols](A_World_Burning/36-appendix-e-reproducibility-protocols.md) • [A_World_Burning/33-appendix-b-filesystem-naming-run-ids](A_World_Burning/33-appendix-b-filesystem-naming-run-ids.md)
...
> [!note] Primary technical references
> [A_World_Burning/37-appendix-f-climate-perturbation-regimes](A_World_Burning/37-appendix-f-climate-perturbation-regimes.md)
...
Guardrails and non-claims are defined in [A_World_Burning/38-appendix-g-ethical-and-interpretive-guardrails](A_World_Burning/38-appendix-g-ethical-and-interpretive-guardrails.md).
...
Model surface area and licensing constraints are captured in [A_World_Burning/39-appendix-h-model-cards-and-dependency-registry](A_World_Burning/39-appendix-h-model-cards-and-dependency-registry.md).
...
The disk contract and run ID law are specified in [A_World_Burning/33-appendix-b-filesystem-naming-run-ids](A_World_Burning/33-appendix-b-filesystem-naming-run-ids.md).
...
> [!note] Primary technical references
> [A_World_Burning/40-appendix-i-known-limitations-and-open-questions](A_World_Burning/40-appendix-i-known-limitations-and-open-questions.md)
...
These refusals are formalized in [A_World_Burning/38-appendix-g-ethical-and-interpretive-guardrails](A_World_Burning/38-appendix-g-ethical-and-interpretive-guardrails.md).
...
- Appendix A: [A_World_Burning/32-appendix-a-corpus-and-source-registry](A_World_Burning/32-appendix-a-corpus-and-source-registry.md)
- Appendix B: [A_World_Burning/33-appendix-b-filesystem-naming-run-ids](A_World_Burning/33-appendix-b-filesystem-naming-run-ids.md)
- Appendix C: [A_World_Burning/34-appendix-c-feature-extraction-inventory](A_World_Burning/34-appendix-c-feature-extraction-inventory.md)
- Appendix D: [A_World_Burning/35-appendix-d-segmentation-methods-and-parameters](A_World_Burning/35-appendix-d-segmentation-methods-and-parameters.md)
- Appendix E: [A_World_Burning/36-appendix-e-reproducibility-protocols](A_World_Burning/36-appendix-e-reproducibility-protocols.md)
- Appendix F: [A_World_Burning/37-appendix-f-climate-perturbation-regimes](A_World_Burning/37-appendix-f-climate-perturbation-regimes.md)
- Appendix G: [A_World_Burning/38-appendix-g-ethical-and-interpretive-guardrails](A_World_Burning/38-appendix-g-ethical-and-interpretive-guardrails.md)
- Appendix H: [A_World_Burning/39-appendix-h-model-cards-and-dependency-registry](A_World_Burning/39-appendix-h-model-cards-and-dependency-registry.md)
- Appendix I: [A_World_Burning/40-appendix-i-known-limitations-and-open-questions](A_World_Burning/40-appendix-i-known-limitations-and-open-questions.md)
- Appendix J: [A_World_Burning/41-appendix-j-glossary](A_World_Burning/41-appendix-j-glossary.md)
